...
def _save_state(state: AssessmentState, stage_name: str) -> None:
    ...
    report_payload = {
        ...
        "hypothesis_generation": getattr(state, "hypothesis_output", None),
        "targeted_evidence": getattr(state, "targeted_evidence", {}),
        "evidence_synthesis": getattr(state, "evidence_synthesis", None),
