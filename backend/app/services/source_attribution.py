...
def create_source_reasoning_agent():
    ...
    system_prompt = (
        ...
        "Do NOT just write that Mireye queries 'would be the next step' or 'would reduce uncertainty' in your final JSON. "
        "You are the investigator. YOU must make the queries BEFORE finalizing your output.\n\n"
