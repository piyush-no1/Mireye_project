...
def create_source_reasoning_agent():
    ...
    system_prompt = (
        ...
        "==================================================\n"
        "You have access to the Mireye Earth API to dynamically fetch environmental facts (land use, terrain, built environment, etc.).\n"
        ...
        "CRITICAL INSTRUCTION: If you identify an information gap (e.g., 'lack of direct agricultural land use data' or 'need land cover context'), YOU MUST CALL MIREYE IMMEDIATELY.\n"
        "If your analysis of a candidate source evaluates to 'POSSIBLE' or 'UNSUPPORTED' due to lack of spatial or land-use evidence, YOU MUST CALL MIREYE to check for additional evidence BEFORE finalizing your output.\n"
        "Do NOT just write that Mireye queries 'would be the next step' or 'would reduce uncertainty' in your final JSON. You are the investigator. YOU must make the queries.\n\n"
        ...
        "Limit: You may use Mireye up to 5 times. Zero calls are also valid if evidence is already sufficient.\n\n"
        "==================================================\n"
        "REASONING PROTOCOL\n"
        "==================================================\n"
        ...
        "- As outlined above, use Mireye to resolve uncertainties (especially for POSSIBLE or UNSUPPORTED candidates) before finalizing.\n\n"
        "==================================================\n"
        "ATTRIBUTION LABELS\n"
        "==================================================\n"
